...
CSC := $(if $(WINDIR),c:/Windows/Microsoft.NET/Framework/v3.5/csc.exe,csc)
MONO := $(if $(WINDIR),,mono)
...
CIVWR = $(addprefix $(srcdir)CiViewer/,Program.cs MainWindow.cs gtk-gui/generated.cs gtk-gui/MainWindow.cs Properties/AssemblyInfo.cs)
